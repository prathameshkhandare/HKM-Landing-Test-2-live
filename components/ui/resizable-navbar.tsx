...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  ...
  const showNav = visible || isHovered
  ...
  return (
    <motion.div
      ...
      animate={{
        backgroundColor: showNav ? "rgba(27, 124, 184)" : "rgba(255, 255, 255, 0)",
      ...
      className={cn(
        "relative z-[60] hidden w-full flex-row items-center justify-between px-4 py-1 lg:flex lg:gap-4",
        className,
      )}
    >
      {children}
