...
interface PhilosophyTempleHeaderProps {
...
export default function PhilosophyTempleHeader({ 
    title, 
    subtitle, 
    stickerText = "Vedic Wisdom",
    imageSrc = "/assets/dakshina-dwaraka-dham.png"
}: PhilosophyTempleHeaderProps) {
  return (
    <div className="relative w-full overflow-hidden bg-[#2D0A0A] min-h-[500px] md:min-h-[600px] flex items-center">
              ...
              <div className="w-full md:w-1/2 text-center md:text-left space-y-8 relative">
                   ...
                   >
                       <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#FFB81C]/20 rounded-full border border-[#FFB81C]/40 text-[#FFB81C] font-bold text-sm uppercase tracking-widest mb-6 backdrop-blur-sm">
                           <Sparkles size={14} className="animate-spin-slow" /> {stickerText}
                       </span>
