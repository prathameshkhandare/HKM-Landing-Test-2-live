                        ...
                        {festivals.map((fest, index) => {
                            const CardContent = (
                                <motion.div
                                    ...
                                    className="group relative rounded-t-2xl rounded-b-lg overflow-hidden shadow-2xl bg-[#1a0505] border border-[#FFB81C]/20 hover:border-[#FFB81C] transition-all duration-500 hover:-translate-y-2 h-full block"
                                >
                            ...
                            return fest.link ? (
                                <Link href={fest.link} key={index} className="block w-full h-full">
                                    {CardContent}
                                </Link>
                            ) : (
