...
export default function SpiritualDiscoursesPage() {
    return (
        <main className="min-h-screen bg-[#FFF9F0] text-[#3A3A3A] font-sans selection:bg-[#FFB81C] selection:text-black relative">
            ...
            {/* Books Display Section - Light Balanced Design */}
            <section className="py-24 px-6 bg-[#FFF9F0] relative overflow-hidden">
                {/* Background Textures - Subtle for Light Theme */}
                <div className="absolute inset-0 bg-[url('/assets/mandala-pattern.png')] bg-repeat opacity-[0.03] animate-slide-slow"></div>

                {/* Decorative Corner Ornaments - Top Left */}
                <div className="absolute top-0 left-0 w-32 h-32 opacity-10">
                    <svg viewBox="0 0 100 100" fill="none" className="w-full h-full">
                        <path d="M0 0 L100 0 L100 20 L20 20 L20 100 L0 100 Z" fill="#701a1a" />
                    </svg>
                </div>
                ...
                <div className="container mx-auto relative z-10">
                    <div className="flex flex-col-reverse lg:flex-row items-center gap-20">
                        ...
                        >
                            {/* Glowing Backdrop for Books - Adjusted for Light Theme */}
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-[#FFB81C] rounded-full blur-[80px] opacity-10"></div>

                            <div className="relative z-10 grid grid-cols-2 gap-8 items-center perspective-1000">
                                {/* Book 1 Frame */}
                                <div className="relative group p-3 bg-white shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)] rounded-sm border border-gray-100 transform rotate-y-12 hover:rotate-y-0 hover:scale-105 transition-transform duration-700 cursor-pointer">
                                     <div className="absolute inset-1.5 border border-[#FFB81C]/20 z-20 pointer-events-none"></div>
                                     <div className="absolute -inset-2 bg-[#701a1a]/5 blur-md rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                    <img 
                                ...
                                {/* Book 2 Frame */}
                                <div className="relative group p-3 bg-white shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)] rounded-sm border border-gray-100 transform -rotate-y-12 hover:rotate-y-0 hover:scale-105 transition-transform duration-700 cursor-pointer translate-y-10">
                                     <div className="absolute inset-1.5 border border-[#FFB81C]/20 z-20 pointer-events-none"></div>
                                     <div className="absolute -inset-2 bg-[#701a1a]/5 blur-md rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"></div>
                                    <img 
                        ...
                        <motion.div
                            ...
                            className="w-full lg:w-1/2 space-y-8"
                        >
                            <div className="inline-flex items-center gap-3 px-4 py-2 bg-[#ea580c]/10 border border-[#ea580c]/20 rounded-full mb-2">
                                <Sparkles size={16} className="text-[#ea580c]" />
                                <span className="text-[#ea580c] font-bold text-xs tracking-widest uppercase">Ancient Scriptures</span>
                            </div>

                            <h2 className="text-4xl md:text-6xl font-bold text-[#701a1a] drop-shadow-sm leading-tight font-serif">
                                Treasures of <br /> <span className="text-[#ea580c] italic font-serif">Vedic Wisdom</span>
                            </h2>

                            <p className="text-[#4a4a4a] text-lg leading-relaxed font-medium border-l-4 border-[#ea580c] pl-6">
                            ...
                            <div className="pt-4">
                                <a
                                    ...
                                    className="group relative inline-flex items-center gap-4 px-8 py-4 bg-[#FFB81C] text-[#2D0A0A] font-bold text-lg rounded-full overflow-hidden transition-all hover:scale-105 hover:shadow-[0_10px_20px_rgba(255,184,28,0.3)] shadow-lg"
                                >
