                  ...
                  {[
                     ...
                     <div key={idx} className="group relative h-[420px] bg-white p-2 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 rounded-sm border border-[#e5e5e5]">
                        <div className="relative h-full w-full overflow-hidden border border-[#1E3A8A]/10">
                           {/* Background Image */}
                           <div className={`absolute inset-0 ${item.objectFit === 'contain' ? 'bg-black/90' : ''}`}> {/* Add dark bg for contain images */}
                              <Image
                                 src={item.img}
                                 alt={item.title}
                                 fill
                                 className={`transition-transform duration-1000 group-hover:scale-110 ${item.objectFit === 'contain' ? 'object-contain' : 'object-cover'}`}
         ...
         <section className="py-24 px-4 md:px-8 max-w-7xl mx-auto bg-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 p-4">
               <div className="relative h-[350px] group overflow-hidden shadow-lg border-4 border-[#FFF9F0] outline outline-1 outline-[#ddd]">
                  <Image src="/activities/sunday-retreats/kirtan-mela.jpg" alt="Monks Kirtan" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#701a1a] via-[#942727] to-[#FFB81C]/40 opacity-0 group-hover:opacity-90 transition-opacity duration-500 flex items-center justify-center">
                     <span className="text-white text-2xl font-bold border-b-2 border-white pb-1 drop-shadow-md transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500"> Kirtan Mela </span>
                  </div>
               </div>
               <div className="relative h-[350px] group overflow-hidden shadow-lg border-4 border-[#FFF9F0] outline outline-1 outline-[#ddd] md:-mt-12 shadow-2xl z-10">
                  <Image src="/activities/sunday-retreats/pallaki_utsava.jpg" alt="Lecture Session" fill className="object-cover group-hover:scale-110 transition-transform duration-700" />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#1E3A8A] via-[#2a59c0] to-[#60a5fa]/40 opacity-0 group-hover:opacity-90 transition-opacity duration-500 flex items-center justify-center">
                     <span className="text-white text-2xl font-bold border-b-2 border-white pb-1 drop-shadow-md transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">Pallaki Utsava</span>
                  </div>
               </div>
               <div className="relative h-[350px] group overflow-hidden shadow-lg border-4 border-[#FFF9F0] outline outline-1 outline-[#ddd]">
            ...
            <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
               <div className="relative p-8 md:p-12 rounded-xl bg-black/20 backdrop-blur-sm border border-[#FFB81C]/30 shadow-2xl">
                  ...
                  <div className="flex justify-center items-center w-full gap-6">
                     <Link
                        href="https://maps.app.goo.gl/3yn5CD8PhWTtLbu67"
                        target="_blank"
