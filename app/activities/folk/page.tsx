...
import { ArrowRight, Star, Heart, Users, Home, BookOpen, Coffee, Lightbulb, UserCheck, Zap, Compass, Phone } from "lucide-react"
      ...
      <section className="relative min-h-[60vh] md:min-h-[75vh] flex items-center justify-center overflow-hidden bg-[#2D0A0A] py-12 md:py-20">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto w-full">
          ...
          >
            ...
            <div className="flex justify-center mb-8 md:mb-10 pt-4 md:pt-8">
              <div className="w-36 h-36 md:w-72 md:h-72 bg-[#FFB81C]/10 rounded-full flex items-center justify-center border-4 border-[#FFB81C] shadow-[0_0_60px_rgba(255,184,28,0.5)] backdrop-blur-sm p-2 md:p-4 hover:scale-105 transition-transform duration-500">
                <Image src="/assets/activitysectionnewimgs/folklogo.png" alt="FOLK Logo" width={450} height={450} className="object-contain w-full h-full drop-shadow-2xl" />
              </div>
            </div>
      ...
      <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto">
        ...
        <div className="space-y-24">
          ...
          <div className="flex flex-col md:flex-row gap-16 items-center group">
            ...
            {/* Elegant Museum Frame for Program 1 */}
            <div className="flex-1 relative order-1 md:order-2 flex justify-center items-center py-10">
              <motion.div
              ...
              >
                ...
                <div className="relative aspect-video w-full bg-[#E0C9A6]/20 overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent flex flex-col justify-end p-6">
                    <span className="text-[#FFB81C] font-bold text-lg tracking-widest uppercase">Aim of Life</span>
                    <span className="text-white text-xs opacity-70">Define Your Purpose</span>
                  </div>
                </div>
              </motion.div>
            </div>
          ...
          {/* Program 2 */}
          <div className="flex flex-col md:flex-row gap-16 items-center group">
            {/* Elegant Museum Frame for Program 2 */}
            <div className="flex-1 relative order-1 flex justify-center items-center py-10">
              ...
              >
                ...
                <div className="relative aspect-video w-full bg-[#E0C9A6]/20 overflow-hidden">
                  <Image
                    src="/activities/folk/folk-dining.png"
                    alt="Discussion"
                    fill
                    className="object-cover group-hover:scale-110 transition-transform duration-700"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent flex flex-col justify-end p-6">
                    <span className="text-[#FFB81C] font-bold text-lg tracking-widest uppercase">Jijnasa</span>
                    <span className="text-white text-xs opacity-70">Discover the Missing Link</span>
                  </div>
                </div>
              </motion.div>
            </div>
          ...
          {/* Program 3 - FOLK Yatra (NEW) */}
          <div className="flex flex-col md:flex-row gap-16 items-center group">
            <div className="flex-1 order-2 md:order-1 space-y-6">
              <div className="inline-block px-5 py-2 bg-[#701a1a] text-[#FFB81C] rounded-full text-sm font-bold mb-2 shadow-lg tracking-widest uppercase">Annual Program</div>
              <h3 className="text-4xl font-bold text-[#701a1a]">3. FOLK Yatra: Soulful Adventure</h3>
              <div className="w-12 h-1 bg-[#FFB81C] rounded-full"></div>
              <p className="text-[#5a5a5a] leading-relaxed text-lg">
                Once we complete the courses, we take the youth to different spiritual places for an immersive experience. These yatras are not just trips but soulful adventures that deepen one's connection with spiritual roots and create lifelong memories with the community.
              </p>
              <div className="relative group/card">
                <div className="absolute -inset-1 bg-gradient-to-r from-[#FFB81C]/20 to-[#ea580c]/20 blur-lg opacity-50 group-hover/card:opacity-100 transition-opacity"></div>
                <div className="relative bg-white/80 backdrop-blur-sm p-8 rounded-2xl border border-white shadow-xl overflow-hidden">
                  {/* Decorative Background Pattern */}
                  <div className="absolute inset-0 bg-[url('/assets/mandala-pattern.png')] bg-[length:200px] opacity-[0.03] pointer-events-none"></div>

                  <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-6">
                      <Compass size={20} className="text-[#ea580c]" />
                      <h4 className="text-[#701a1a] font-bold uppercase tracking-[0.2em] text-xs">A Soulful Pilgrimage to</h4>
                    </div>

                    <div className="grid grid-cols-2 gap-x-8 gap-y-4">
                      {[
                        "Vrindavan Dham", "Jagannath Puri", "Mayapur Dham", "Ahobilam",
                        "Sri Rangam", "Tirupati", "Haridwar", "Rishikesh"
                      ].map((place, i) => (
                        <motion.div
                          key={i}
                          whileHover={{ x: 5 }}
                        ...
                        >
                          <div className="w-1.5 h-1.5 rounded-full bg-[#FFB81C] group-hover/item:scale-150 transition-transform shadow-[0_0_8px_rgba(255,184,28,0.8)]"></div>
                          <span className="text-sm font-serif font-semibold text-[#4a4a4a] group-hover/item:text-[#701a1a] transition-colors">{place}</span>
                        </motion.div>
                      ))}
                    </div>
                    ...
                    <div className="mt-8 flex items-center gap-4 opacity-40">
                      <div className="h-[1px] flex-1 bg-gradient-to-r from-transparent to-[#ea580c]"></div>
                      <div className="w-1.5 h-1.5 rotate-45 border border-[#ea580c]"></div>
                      <div className="h-[1px] flex-1 bg-gradient-to-l from-transparent to-[#ea580c]"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Elegant Museum Frame for Yatra Image */}
            <div className="flex-1 relative order-1 md:order-2 flex justify-center items-center py-10">
              <motion.div
                whileHover={{ scale: 1.05, rotate: 0 }}
                initial={{ rotate: -2 }}
                className="relative w-full max-w-2xl p-4 bg-white shadow-[0_30_60px_-15px_rgba(0,0,0,0.3)] rounded-sm border border-gray-100 transition-all duration-700 cursor-pointer"
              >
                {/* Inner Golden Border */}
                <div className="absolute inset-2 border border-[#FFB81C]/30 z-20 pointer-events-none"></div>
                ...
                <div className="relative aspect-video w-full bg-[#E0C9A6]/20 overflow-hidden">
                  <Image
                    src="/assets/activities/folkyatraimg.png"
                    alt="FOLK Yatra"
                    fill
                    className="object-cover opacity-80 group-hover:opacity-100 transition-opacity duration-500"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent flex flex-col justify-end p-6">
                    <span className="text-[#FFB81C] font-bold text-lg tracking-widest uppercase">Soulful Adventure</span>
                    <span className="text-white text-xs opacity-70">Experience the Divine</span>
                  </div>
                </div>
              </motion.div>
            </div>
