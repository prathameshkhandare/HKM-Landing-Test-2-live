...
export default function YugaDharmaPage() {
    ...
    return (
        <div className="min-h-screen bg-[#FFF9F0] text-[#3A3A3A] font-sans">
            ...
            <section className="relative min-h-[100svh] md:min-h-[60vh] h-auto flex py-16 md:py-0 items-center justify-center overflow-hidden bg-[#2D0A0A]">
                ...
                <div className="relative z-10 w-full px-4 max-w-[90rem] mx-auto pt-10 h-full flex flex-col md:flex-row flex-wrap md:flex-nowrap items-center justify-center md:justify-between gap-y-8 md:gap-4 pb-10 md:pb-0">
                    ...
                    <motion.div
                        ...
                        className="text-center w-full md:w-2/4 relative z-30 order-1 md:order-2 -mt-4 md:mt-0"
                    >
                        {/* Musical Icon */}
                        ...
                        <h1 className="text-4xl md:text-7xl lg:text-8xl font-bold text-white mb-4 tracking-tight drop-shadow-[0_4px_8px_rgba(0,0,0,0.6)]">
                            Yuga <span className="text-[#FFB81C] font-serif italic text-shadow-glow">Dharma</span>
                        </h1>

                        {/* Ornamental Divider */}
                        <div className="flex items-center justify-center gap-4 mb-6">
                            <div className="h-[2px] w-12 md:w-16 bg-gradient-to-l from-[#FFB81C] to-transparent"></div>
                            <div className="w-3 h-3 rotate-45 border-2 border-[#FFB81C] shadow-[0_0_10px_#FFB81C]"></div>
                            <div className="h-[2px] w-12 md:w-16 bg-gradient-to-r from-[#FFB81C] to-transparent"></div>
                        </div>

                        <p className="text-xl md:text-2xl lg:text-3xl text-[#ffe8cc] font-light leading-relaxed max-w-2xl mx-auto italic drop-shadow-md">
                            "Sankirtana Yajna - The Sole Hope for World Peace and Prosperity"
                        </p>
                    </motion.div>

                    {/* MOBILE ONLY: Featured Auto-sliding Portrait Image */}
                    <div className="w-full flex md:hidden items-center justify-center relative z-20 order-2 mt-4">
                        <div className="relative w-64 aspect-[3/4] rounded-2xl overflow-hidden shadow-[0_0_30px_rgba(255,184,28,0.2)] bg-black/20 backdrop-blur-sm border-2 border-[#FFB81C]/50 flex items-center justify-center p-2">
                            <div className="relative w-full h-full rounded-xl overflow-hidden">
                                <AnimatePresence mode="wait">
                                    {currentMobileImage === 0 ? (
                                        ...
                                        >
                                            <Image
                                                src="/activities/yuga-dharma/hare_krishna_mantra_authentic_1771653727989.png"
                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-[#FFB81C]/10 to-transparent pointer-events-none mix-blend-overlay"></div>
                            </div>
                        </div>
                        {/* Sparkles Mobile */}
                        <div className="absolute top-4 left-[20%] animate-pulse"><Sparkles className="text-[#FFF9F0] w-6 h-6" /></div>
                        <div className="absolute bottom-6 right-[20%] animate-bounce-slow"><Sparkles className="text-[#FFB81C] w-4 h-4" /></div>
                    </div>

                    {/* DESKTOP ONLY: Left Decor Image - Sankirtana Vector */}
                    <motion.div
                        initial={{ opacity: 0, x: -50 }}
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.8, delay: 0.2 }}
                        className="hidden md:flex w-1/4 items-center justify-center relative z-20 order-1"
                    >
                        <div className="relative w-64 md:h-80 rounded-2xl overflow-hidden shadow-[0_0_30px_rgba(255,184,28,0.2)] bg-black/20 backdrop-blur-sm group hover:shadow-[0_0_50px_rgba(255,184,28,0.4)] transition-all duration-500 border-2 border-[#FFB81C]/50 flex items-center justify-center p-2 mt-12">
                            <div className="relative w-full h-full rounded-xl overflow-hidden">
                                <Image
                                    src="/assets/sankirtana.jpg"
                                    alt="Sankirtana Movement"
                        ...
                        {/* Sparkles Desktop */}
                        <div className="absolute top-4 -left-4 animate-pulse"><Sparkles className="text-[#FFF9F0] w-6 h-6" /></div>
                        <div className="absolute bottom-6 -right-2 animate-bounce-slow"><Sparkles className="text-[#FFB81C] w-4 h-4" /></div>
                    </motion.div>

                    {/* DESKTOP ONLY: Right Decor Image - Hare Krishna Mantra */}
                    <motion.div
                        initial={{ opacity: 0, x: 50 }}
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.8, delay: 0.4 }}
                        className="hidden md:flex w-1/4 items-center justify-center relative z-20 order-3"
                    >
                        <div className="relative w-64 md:h-80 rounded-t-[3rem] md:rounded-t-full rounded-b-xl md:rounded-b-3xl overflow-hidden border-[3px] md:border-[4px] border-[#ea580c]/40 shadow-[0_0_30px_rgba(234,88,12,0.2)] bg-white/5 backdrop-blur-sm group hover:border-[#ea580c] hover:shadow-[0_0_50px_rgba(234,88,12,0.4)] transition-all duration-500">
                            <Image
                                src="/activities/yuga-dharma/hare_krishna_mantra_authentic_1771653727989.png"
                                alt="Authentic Hare Krishna Maha Mantra"
                                fill
                                className="object-cover p-1 transform group-hover:scale-105 transition-transform duration-700 drop-shadow-xl"
                                priority
                            />
                            {/* Internal Glow */}
                            <div className="absolute inset-0 bg-gradient-to-b from-[#ea580c]/10 to-transparent pointer-events-none mix-blend-overlay"></div>
                        </div>
                        {/* Sparkles Desktop */}
                        <div className="absolute top-10 -right-4 animate-bounce-slow"><Sparkles className="text-[#FFB81C] w-5 h-5" /></div>
                        <div className="absolute -bottom-2 -left-2 animate-pulse"><Sparkles className="text-[#FFF9F0] w-6 h-6" /></div>
                    </motion.div>
