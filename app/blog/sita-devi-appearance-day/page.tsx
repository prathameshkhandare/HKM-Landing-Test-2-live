...
const blogJsonLd = {
  ...
  publisher: {
    '@type': 'Organization',
    name: 'Dakshina Dwaraka Dham — HKM Chennai',
        ...
        <div className={styles.connectSection}>
          ...
          <div className={styles.platformGrid}>
            ...
            <a className={`${styles.platformLink} ${styles.plLinkedin}`} href="https://www.linkedin.com/company/hare-krishna-movement-chennai/" target="_blank" rel="noopener noreferrer">
              ...
              <span className={styles.plLabel}><strong>HKM Chennai</strong><span className={styles.plName}>LinkedIn</span></span>
            </a>
            <a className={`${styles.platformLink} ${styles.plWhatsapp}`} href="https://www.whatsapp.com/channel/0029Vaa2fjKEVccFHx5YDt1O" target="_blank" rel="noopener noreferrer">
              ...
              <span className={styles.plLabel}><strong>WhatsApp Channel</strong><span className={styles.plName}>HKM Chennai Official</span></span>
            </a>
          </div>
