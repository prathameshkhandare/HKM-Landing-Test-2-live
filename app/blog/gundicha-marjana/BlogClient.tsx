        ...
        <div className="min-h-screen bg-[#FFF9F0] selection:bg-[#c9973a] selection:text-white">
            ...
            <article className="gp-blog-wrap">
                ...
                <div className="gp-image-container" style={{ marginTop: '0', marginBottom: '3rem' }}>
                    <img src="/images/gundicha-marjana-header.jpg" alt="Devotees joyfully cleaning the Gundicha temple with brooms and water pots" className="gp-image" />
                    <span className="gp-image-caption">Devotees joyfully cleansing the Gundicha temple in preparation for Lord Jagannath&apos;s arrival.</span>
                </div>
                ...
                <nav className="gp-toc" aria-label="Table of Contents">
                    <div className="gp-toc-inner">
                        ...
                        <ol className="gp-toc-list">
                            ...
                            <li><a href="#gundicha-temple"><span className="gp-toc-num">02</span>The Gundicha Temple: The Lord&apos;s Garden House</a></li>
                            <li><a href="#cleaning-need"><span className="gp-toc-num">03</span>Why the Temple Needs Cleaning</a></li>
                            <li><a href="#pastime"><span className="gp-toc-num">04</span>The Pastime, As Recorded in Chaitanya-charitamrita</a></li>
                            <li><a href="#dvaraka-vrindavana"><span className="gp-toc-num">05</span>Nilachala as Dvaraka-Kurukshetra, Gundicha as Vrindavana</a></li>
                            <li><a href="#cleaning-heart"><span className="gp-toc-num">06</span>Cleaning the Heart: Srila Prabhupada&apos;s Teaching</a></li>
                            <li><a href="#leadership"><span className="gp-toc-num">07</span>An Acharya&apos;s Example of Leadership</a></li>
                ...
                <div className="gp-content">
                    ...
                    <section id="pastime">
                        ...
                        <h3 className="gp-sh3">Preparing for the Cleaning</h3>
                        ...
                        <h3 className="gp-sh3">The Sweeping</h3>
                        ...
                        <h3 className="gp-sh3">The Washing</h3>
                    </section>
                    ...
                    <section>
                        ...
                        <h3 className="gp-sh3">Teaching Through Praise and Correction</h3>
                        ...
                        <h3 className="gp-sh3">An Act of Humility: The Charanamrita Incident</h3>
                        ...
                        <h3 className="gp-sh3">After the Cleaning: Ecstatic Dancing</h3>
                    </section>
                    ...
                    <section>
                        ...
                        <h3 className="gp-sh3">The Prasadam Feast</h3>
                        ...
                        <h3 className="gp-sh3">Netrotsava: The Joy of Seeing the Lord Again</h3>
                    ...
                    <blockquote className="gp-bq">
                        ...
                        <cite>Glory to the Sri Krishna sankirtana, which cleanses the heart of all the dust accumulated for years and extinguishes the fire of conditional life, of repeated birth and death. — Sri Chaitanya-charitamrita, Antya-lila 20.12 (Shikshashtaka, Verse 1)</cite>
                    </blockquote>
                    ...
                    <section id="faq">
                        ...
                        <div className="gp-faq-grid">
                            <div className="gp-faq-item">
                                <p className="gp-faq-q">What is Gundicha Marjana?</p>
                                <p className="gp-faq-a">Gundicha Marjana is the ceremonial cleansing of the Gundicha Temple in Puri, performed the day before Ratha Yatra to prepare the temple for the arrival of Lord Jagannath, Lord Balabhadra, and Devi Subhadra. Sri Chaitanya Mahaprabhu personally performed this cleaning with hundreds of devotees five hundred years ago.</p>
                            </div>
                            <div className="gp-faq-item">
                                <p className="gp-faq-q">When is Gundicha Marjana observed?</p>
                                <p className="gp-faq-a">It is observed every year on the day immediately preceding Ratha Yatra, as part of the preparations for the Lord&apos;s week-long stay at the Gundicha Temple.</p>
                            </div>
                            <div className="gp-faq-item">
                                <p className="gp-faq-q">Why does the Gundicha Temple need to be cleaned every year?</p>
                                <p className="gp-faq-a">The temple stands empty for most of the year and, being open to the elements in traditional temple architecture, gathers dust and dirt. It must be thoroughly cleaned to be a fit residence for Lord Jagannath during His annual seven-day stay.</p>
                            </div>
                            <div className="gp-faq-item">
                                <p className="gp-faq-q">What does ceto-darpana-marjanam mean?</p>
                                <p className="gp-faq-a">It is the opening line of Sri Chaitanya Mahaprabhu&apos;s Shikshashtaka (Chaitanya-charitamrita, Antya-lila 20.12), meaning &apos;cleansing of the mirror of the heart.&apos; It compares the heart to a dust-covered mirror that must be cleaned — through chanting the holy names — before one can perceive the Lord within.</p>
                            </div>
                            <div className="gp-faq-item">
                                <p className="gp-faq-q">How is Gundicha Marjana connected to Ratha Yatra?</p>
                                <p className="gp-faq-a">It is not a separate festival but the opening chapter of the Ratha Yatra story. In Sri Chaitanya Mahaprabhu&apos;s understanding, the main Jagannath Temple represents Dvaraka-Kurukshetra, and the Gundicha Temple represents Vrindavana. Cleansing the Gundicha Temple is the preparation of Vrindavana itself to receive Krishna, making Ratha Yatra a reunion, not merely a procession.</p>
                            </div>
                            <div className="gp-faq-item">
                                <p className="gp-faq-q">Did Sri Chaitanya Mahaprabhu really clean the temple Himself?</p>
                                <p className="gp-faq-a">Yes. According to Sri Chaitanya-charitamrita, Madhya-lila, Chapter 12, He personally swept, washed, and mopped the temple alongside hundreds of devotees, even using His own garment to clean the Deity&apos;s throne, and shed tears of love while doing so.</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="references">
                        ...
                        <ul className="gp-teachings-list">
                            <li>Sri Chaitanya-charitamrita, Madhya-lila, Chapter 12, &ldquo;The Cleansing of the Gundicha Temple&rdquo; — Srila Krishnadasa Kaviraja Gosvami, with purports by His Divine Grace A.C. Bhaktivedanta Swami Prabhupada.</li>
