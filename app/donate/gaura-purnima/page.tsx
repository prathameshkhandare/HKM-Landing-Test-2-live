...
const carouselImages = [
    ...
    "/assets/gaura-purnima/3.JPG",
    "/assets/gaura-purnima/3.5.JPG",
    "/assets/gaura-purnima/3.6.JPG",
    "/assets/gaura-purnima/3.7.JPG",
    "/assets/gaura-purnima/3.8.JPG",
    "/assets/gaura-purnima/4.JPG",
    "/assets/gaura-purnima/5.JPG"
]
...
function ImageCarousel() {
    ...
    return (
        <div className="relative w-full max-w-6xl mx-auto group">
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        <img
                            ...
                            alt={`Gaura Purnima Spirit ${currentIndex + 1}`}
                        />
                        {/* Gradient Overlays */}
                    ...
                    <div className="absolute bottom-16 left-12 p-0 z-30 pointer-events-none">
                        <motion.div layout className="bg-[#5c0a0a]/95 backdrop-blur-md px-6 py-5 rounded-2xl border border-[#FFB81C]/30 shadow-[0_15px_30px_rgba(0,0,0,0.8)] max-w-sm">
                            ...
                            <h3 className="text-3xl lg:text-4xl font-black font-serif text-white mb-2 drop-shadow-lg leading-tight">
                                Experience the <br />
                                <span className="text-[#FFB81C] italic">Divine Spirit</span>
                            </h3>
                            <p className="text-white/90 text-sm font-serif italic leading-snug drop-shadow max-w-[280px]">
                                "Let your heart dance in the golden light of Harinama Sankirtana."
                            </p>
                        </motion.div>
                    </div>
                </div>
                ...
                <div className="absolute inset-0 z-20 flex flex-col items-center justify-between py-12 px-6 md:hidden pointer-events-none">
                    ...
                    <div className="mt-4 pointer-events-auto">
                        <h3 className="text-xl font-black text-white text-center uppercase tracking-wider drop-shadow-2xl font-serif leading-tight bg-black/20 backdrop-blur-sm px-6 py-2 rounded-full border border-white/10">
                            Glimpses of <span className="text-[#FFB81C]">Gaura Purnima</span>
                        </h3>
                    </div>
            ...
            {/* Desktop Thumbnails (Below Frame) */}
                    ...
                    <div className="flex items-center gap-4">
                        {carouselImages.map((img, idx) => (
                            <button
                                ...
                                className={`relative h-20 w-28 flex-shrink-0 rounded-xl overflow-hidden transition-all duration-500 border-2 ${currentIndex === idx
                                    ? "border-[#FFB81C] scale-110 shadow-[0_10px_20px_rgba(234,88,12,0.3)] z-10"
    ...
    return (
        <div className="min-h-screen bg-[#FFF9F0] text-[#3A3A3A] font-sans selection:bg-[#FFB81C] selection:text-white">
            ...
            <section className="relative h-[60vh] min-h-[450px] flex flex-col items-center justify-center overflow-hidden bg-[#2D0A0A] pt-24 pb-8 px-4">
                {/* Background - Saffron/Gold/Purple Gradient */}
                ...
                <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
                    ...
                    >
                        ...
                        >
                            ...
                            {/* Glowing Center Core */}
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 bg-[#FFEAA7] rounded-full shadow-[0_0_20px_5px_#FFB81C] animate-ping" style={{ animationDuration: '4s' }}></div>
                        ...
                        <div className="flex flex-row items-center justify-center gap-3 sm:gap-6 lg:gap-12 w-full mb-4 px-2">
                            ...
                            <h1 className="flex flex-col items-center justify-center space-y-2 shrink min-w-0">
                                ...
                                <span className="text-2xl min-[400px]:text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white tracking-tighter drop-shadow-[0_10px_20px_rgba(0,0,0,0.8)] font-serif uppercase leading-none mt-2 whitespace-nowrap">
                                    Appearance Day
                                </span>
                                <span className="text-sm sm:text-lg md:text-xl lg:text-2xl font-bold text-white/90 tracking-normal drop-shadow-[0_4px_8px_rgba(0,0,0,0.4)] font-serif mt-2 sm:mt-4 text-center block">
                        ...
                        <div className="inline-flex flex-col sm:flex-row items-center justify-center gap-4 bg-white/10 backdrop-blur-md px-6 py-3 rounded-2xl border border-white/20 mb-4 shadow-xl">
                            <div className="text-center sm:text-left">
                                <p className="text-[#FFD700] text-[9px] font-bold uppercase tracking-widest mb-0.5">Festival Dates</p>
                                <p className="text-white font-serif text-xl">1st & 3rd March 2026</p>
                            </div>
                            <div className="w-[1px] h-8 bg-white/20 hidden sm:block"></div>
                            <div className="text-center sm:text-left">
                                <p className="text-[#FFD700] text-[9px] font-bold uppercase tracking-widest mb-0.5">Special Observe</p>
                                <p className="text-white font-serif text-lg">Fasting till moon rise on 3rd March</p>
                            </div>
                        </div>

                        <p className="text-lg md:text-xl text-[#ffe3bc] font-light leading-relaxed max-w-3xl mx-auto italic drop-shadow-md pt-2">
                            "Join us in the golden ecstasy of Harinama Sankirtana"
                        </p>
                    </motion.div>
                </div>
            </section>
                ...
                <div className="relative mb-32 text-center w-full px-4 md:px-0">
                    ...
                    >
                        ...
                        <p className="text-gray-500 max-w-3xl mx-auto italic text-xl md:text-3xl mt-12 font-serif leading-relaxed px-4">
                            "Experience the divine appearance of the Golden Avatar who gave the world the Hare Krishna Maha Mantra."
                        </p>
                    </motion.div>
                    ...
                    <div className="lg:col-span-7 space-y-12">
                        <div className="flex items-center gap-6 border-b border-gray-100 pb-6">
                            ...
                            <div>
                                ...
                                <p className="text-[#ea580c] font-bold text-sm tracking-widest uppercase">1st & 3rd March 2026</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8 relative before:absolute before:left-[19px] before:top-2 before:bottom-2 before:w-[2px] before:bg-gradient-to-b before:from-[#ea580c] before:via-[#FFB81C] before:to-transparent">
                            {[
                                { time: "SUN, 1ST MARCH, 5:30 PM", title: "Sri Chaitanya Rasotsava", desc: "A magnificent dance drama presented by Dakshina Dwaraka Vaisnavi Sanga" },
                                { time: "TUE, 3RD MARCH, 7:30 PM", title: "Maha Abhishekam", desc: "The grand bathing ceremony of the Deities with auspicious items." },
                                { time: "TUE, 3RD MARCH, Evening", title: "Sandhya Arati & Shayana Arati", desc: "Special aratis to conclude the auspicious appearance day." },
                            ].map((item, idx) => (
                        ...
                        <div className="bg-[#FFF9F0] p-12 rounded-[3.5rem] border-2 border-dashed border-[#FFB81C]/40 relative overflow-hidden group shadow-inner">
                            ...
                            <div className="relative z-10 text-center space-y-6">
                                ...
                                <p className="text-gray-600 italic text-lg leading-relaxed font-serif">
                                    "All are cordially invited to the festival. Come and receive the boundless mercy of Sri Chaitanya Mahaprabhu."
                                </p>
                ...
                >
                    ...
                    <div className="relative z-10 space-y-8">
                        <p className="text-[#666666] text-xl leading-relaxed font-serif italic mb-8">
                            "By contributing to Sri Gaura Purnima Mahaotsava, you support the grand festivities including the beautiful Abhishekams and the widespread distribution of sacred prasadam. Experience the joy of giving."
                        </p>

                        <a
                            href="https://rzp.io/rzp/qf2drtT7"
                            target="_blank"
                    ...
                    {[
                        {
                            ...
                            desc: "Accumulate boundless spiritual blessings by serving Sri Chaitanya Mahaprabhu on His appearance day.",
                            icon: <CheckCircle2 className="text-[#FFB81C]" size={32} />
                        },
                        {
                            title: "Community Service",
                            desc: "Support the massive distribution of free prasadam to visiting devotees.",
                            icon: <MapPin className="text-[#FFB81C]" size={32} />
                        },
                        {
                            title: "Ancient Tradition",
                            desc: "Help preserve and propagate the teachings of Sri Chaitanya Mahaprabhu.",
                        ...
                        <motion.div
                            ...
                            className="bg-gradient-to-b from-[#FFF9F0] to-white p-10 rounded-[2rem] shadow-xl border border-[#FFB81C]/30 text-center relative overflow-hidden group hover:-translate-y-2 transition-transform duration-500"
                        >
                            ...
                            <div className="mb-6 flex justify-center relative z-10">
                                <div className="w-16 h-16 bg-[#2D0A0A] rounded-full flex items-center justify-center border-2 border-[#FFB81C]/50 shadow-[0_0_15px_rgba(255,184,28,0.3)] group-hover:scale-110 transition-transform duration-500">
                                    {benefit.icon}
                                </div>
                            </div>

                            <h4 className="text-2xl font-bold text-[#701a1a] mb-4 font-serif relative z-10 group-hover:text-[#ea580c] transition-colors">{benefit.title}</h4>
