        ...
        <div className="container mx-auto text-center relative z-10 px-4">
          ...
          >
            ...
            <h1 className="text-4xl md:text-7xl font-bold text-white mb-4 tracking-tight drop-shadow-[0_4px_8px_rgba(0,0,0,0.6)]">
              Gopala <span className="text-[#FFB81C] font-serif italic">Seva</span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-[#ffe8cc] font-light leading-relaxed max-w-3xl mx-auto italic">
              "Annual Giving Program - ₹1,000/year"
            </p>
          </motion.div>
        </div>
      </section>
        ...
        >
          ...
          <div className="relative bg-[#FFF9F0] p-1.5 rounded-[2rem] shadow-xl overflow-hidden">
            ...
            <div className="bg-white rounded-[1.7rem] p-8 relative overflow-hidden h-full">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-2xl font-bold mb-4 text-[#701a1a] font-serif">Gopala <span className="text-[#FFB81C]">Seva</span></h2>
          ...
          <Card className="border-2 border-[#FFB81C]/30 rounded-2xl shadow-xl overflow-hidden">
            ...
            <CardContent className="pt-6 space-y-4 text-[#666666] bg-white">
              {[
                { label: "Frequency", value: "Annual (once per year)" },
                { label: "Flexibility", value: "Modify or cancel with notice" },
                { label: "Tax Benefit", value: "Section 80G tax deduction" },
                { label: "Receipt", value: "Annual receipt and recognition" },
              ].map((item, idx) => (
          ...
          <div className="bg-white rounded-[2rem] p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-[#701a1a] font-serif">Set Up Your Annual <span className="text-[#FFB81C]">Donation</span></h3>
              </div>
              ...
              <form className="space-y-6 max-w-2xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-[#701a1a] font-semibold mb-2">Annual Amount (₹)</label>
                    <input
                      type="number"
                      className="w-full px-4 py-3 border-2 border-[#FFB81C]/30 rounded-xl focus:outline-none focus:border-[#FFB81C] bg-[#FFF9F0]"
                      placeholder="1000"
                ...
                >
                  <Heart size={20} className="fill-current" /> Set Up Annual Donation
                </button>
              </form>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[2rem] p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="text-center mb-10">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-[#701a1a] font-serif">Gopala Seva <span className="text-[#FFB81C]">Benefits</span></h3>
              </div>
              
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  { title: "Annual Recognition Ceremony", desc: "Special recognition event honoring our major donors." },
                  { title: "Detailed Annual Report", desc: "Comprehensive report on all programs and initiatives." },
                  { title: "Special Blessing Ceremony", desc: "Special blessing from our spiritual leaders." },
                  { title: "Lifetime Recognition Plaque", desc: "Permanent recognition in our temple." },
                ].map((item, idx) => (
