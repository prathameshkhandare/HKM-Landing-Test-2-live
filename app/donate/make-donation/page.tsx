...
export default function MakeDonationPage() {
  return (
    <div className="min-h-screen bg-[#FFF9F0] text-[#3A3A3A] font-sans selection:bg-[#FFB81C] selection:text-white">
      ...
      {/* Hero Section - Deep Royal Blue & Gold */}
      <section className="relative h-[50vh] min-h-[400px] pt-32 flex items-center justify-center overflow-hidden bg-[#0f172a]">
        {/* Gradients */}
        ...
        <div className="container mx-auto text-center relative z-10 px-4">
            <div className="inline-block px-4 py-1.5 rounded-full bg-[#FFB81C]/10 border border-[#FFB81C]/30 text-[#FFB81C] text-sm font-bold tracking-widest uppercase mb-6 backdrop-blur-sm">
                 Heart of Devotion
            </div>
            ...
            <p className="text-xl md:text-2xl text-blue-100 font-light max-w-3xl mx-auto leading-relaxed italic">
      ...
      <section className="max-w-7xl mx-auto px-4 py-20 -mt-20 relative z-10">
        ...
        <div className="mb-24">
            <div className="text-center mb-12">
               <h2 className="text-3xl md:text-4xl font-bold text-[#0f172a] font-serif inline-block relative">
            ...
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <Card className="hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border-2 border-[#FFB81C]/10 group overflow-hidden relative rounded-2xl bg-white shadow-lg flex flex-col h-full ring-1 ring-black/5">
                    ...
                    <CardContent className="pt-8 px-8 pb-8 flex-1 flex flex-col">
                        <CardTitle className="text-2xl text-[#0f172a] font-serif leading-tight mb-4 group-hover:text-[#FFB81C] transition-colors">
                        ...
                        <Link href="/dakshina-dwaraka#contribute" className="mt-auto block w-full">
                             <button className="w-full py-4 bg-[#0f172a] text-white rounded-xl font-bold hover:bg-[#1e293b] transition-all shadow-md hover:shadow-xl flex items-center justify-center gap-2 group-hover:gap-3">
        ...
        <div className="relative bg-[#FFF9F0] p-1.5 rounded-[2.5rem] shadow-2xl overflow-hidden mb-12 transform hover:scale-[1.005] transition-transform duration-500">
             ...
             <div className="bg-white rounded-[2rem] p-8 md:p-12 relative overflow-hidden">
                 ...
                 <div className="relative z-10 mb-12 text-center">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold text-[#0f172a] font-serif">Other Ways to Give</h2>
                    <p className="text-gray-500 mt-4 max-w-2xl mx-auto">We've made it simple for you to support our mission. Choose the method that works best for you.</p>
                </div>
                ...
                {donationMethods.map((method, index) => (
                    <div key={index} className="flex gap-6 p-6 rounded-2xl bg-[#F8F6F1] border border-[#FFB81C]/10 hover:border-[#FFB81C]/50 transition-all duration-300 hover:shadow-lg hover:bg-[#FFF9F0] group">
                        <div className="flex-shrink-0">
                             <div className="w-12 h-12 rounded-full bg-[#0f172a] text-[#FFB81C] flex items-center justify-center font-bold text-lg shadow-md group-hover:scale-110 transition-transform ring-4 ring-[#FFB81C]/10">
                                {index + 1}
                             </div>
                        </div>
                        <div>
                            <h3 className="text-xl font-bold text-[#0f172a] mb-3 font-serif group-hover:text-[#ea580c] transition-colors">{method.title}</h3>
                            <p className="text-gray-500 mb-5 text-sm font-medium italic">{method.description}</p>
                            <ul className="space-y-3">
                                 {method.steps.map((step, i) => (
                                    <li key={i} className="text-sm text-gray-700 flex items-start gap-3">
                                         <Check size={14} className="text-[#FFB81C] mt-1 shrink-0 stroke-[3px]" />
                 ...
                 {/* Important Note */}
                 <div className="mt-12 p-6 bg-gradient-to-r from-blue-50 to-white rounded-xl border border-blue-100 flex flex-col md:flex-row items-center gap-6 relative overflow-hidden shadow-sm">
                    <div className="flex-shrink-0 bg-blue-100/50 p-3 rounded-full text-[#0f172a]">
                        <AlertCircle size={28} />
                    </div>
                    <div className="relative z-10 text-center md:text-left">
                         <h4 className="font-bold text-[#0f172a] text-lg mb-1 font-serif">Tax Benefits & Privacy</h4>
