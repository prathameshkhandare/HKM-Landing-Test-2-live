                        ...
                        */}
                        ...
                        <Card className="hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border-2 border-[#FFB81C]/20 group overflow-hidden relative rounded-2xl bg-white shadow-lg flex flex-col h-full ring-1 ring-black/5">
                            <div className="relative h-64 overflow-hidden">
                                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent z-10"></div>
                                <Image
                                    src="/assets/gaura-purnima/3.5.JPG"
                                    alt="Gaura Purnima Festival"
                                    fill
                                    className="object-cover group-hover:scale-110 transition-transform duration-700"
                                />
                                <div className="absolute bottom-4 left-6 z-20">
                                    ...
                                    <h3 className="text-white font-bold text-xl font-serif">Gaura Purnima</h3>
                                </div>
                            </div>
                            ...
                            <CardContent className="pt-8 px-8 pb-8 flex-1 flex flex-col">
                                ...
                                <p className="text-[#666666] leading-relaxed mb-8 font-medium">
                                    Receive the boundless mercy of Sri Chaitanya Mahaprabhu on His auspicious appearance day.
                                </p>
                                <Link href="/donate/gaura-purnima" className="mt-auto w-full py-3 px-2 bg-gradient-to-r from-[#ea580c] to-[#d97706] text-white rounded-xl font-bold hover:from-[#d97706] hover:to-[#c2410c] transition-all shadow-md hover:shadow-xl flex items-center justify-center gap-1 group-hover:gap-2 text-center whitespace-nowrap text-[10px] sm:text-xs lg:text-sm">
                                    Donate for Gaura Purnima <ArrowRight size={14} className="flex-shrink-0" />
                                </Link>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border-2 border-[#FFB81C]/20 group overflow-hidden relative rounded-2xl bg-white shadow-lg flex flex-col h-full ring-1 ring-black/5">
                            ...
                            <CardContent className="pt-8 px-8 pb-8 flex-1 flex flex-col">
                                ...
                                <a href="https://campaigns.hkmchennai.org/srila-prabhupada-s-iskcon-thiruvanmiyur-campaign" target="_blank" rel="noopener noreferrer" className="mt-auto w-full py-3 px-2 bg-gradient-to-r from-[#ea580c] to-[#d97706] text-white rounded-xl font-bold hover:from-[#d97706] hover:to-[#c2410c] transition-all shadow-md hover:shadow-xl flex items-center justify-center gap-1 group-hover:gap-2 text-center whitespace-nowrap text-[10px] sm:text-xs lg:text-sm">
                                    Donate for Construction <ArrowRight size={14} className="flex-shrink-0" />
                                </a>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border-2 border-[#FFB81C]/20 group overflow-hidden relative rounded-2xl bg-white shadow-lg flex flex-col h-full ring-1 ring-black/5">
                            ...
                            <CardContent className="pt-8 px-8 pb-8 flex-1 flex flex-col">
                                ...
                                <a href="https://pages.razorpay.com/pl_R4IdxTYoX0AorN/view" target="_blank" rel="noopener noreferrer" className="mt-auto w-full py-3 px-2 bg-gradient-to-r from-[#ea580c] to-[#d97706] text-white rounded-xl font-bold hover:from-[#d97706] hover:to-[#c2410c] transition-all shadow-md hover:shadow-xl flex items-center justify-center gap-1 group-hover:gap-2 text-center whitespace-nowrap text-[10px] sm:text-xs lg:text-sm">
                                    Donate for Youth <ArrowRight size={14} className="flex-shrink-0" />
                                </a>
                            </CardContent>
                        </Card>
                    </div>
