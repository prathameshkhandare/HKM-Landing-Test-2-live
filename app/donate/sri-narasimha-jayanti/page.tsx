...
const festivalImages = [
  "/donate/narasimha-jayanti/narsimha_jayanti_1.JPG",
  "/donate/narasimha-jayanti/narsimha_jayanti_2.JPG",
  "/donate/narasimha-jayanti/narsimha_jayanti_3.JPG",
  "/donate/narasimha-jayanti/narsimha_jayanti_4.JPG",
  "/donate/narasimha-jayanti/narsimha_jayanti_5.JPG",
  "/donate/narasimha-jayanti/narsimha_jayanti_6.JPG",
  "/donate/narasimha-jayanti/narsimha_jayanti_7.JPG",
]
...
function ImageCarousel() {
  ...
  useEffect(() => {
    ...
    if (festivalImages.length <= 1) return;
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto group">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <img
              ...
              alt={`Sri Narasimha Jayanti ${currentIndex + 1}`}
            />
          ...
          <div className="absolute bottom-10 left-12 z-30 pointer-events-none">
            <motion.div layout className="bg-[#5c0a0a]/95 backdrop-blur-md px-6 py-5 rounded-2xl border border-[#FFB81C]/30 shadow-[0_15px_30px_rgba(0,0,0,0.8)] max-w-sm">
              ...
              <h3 className="text-3xl lg:text-4xl font-black font-serif text-white mb-2 drop-shadow-lg leading-tight">
                Celebrate <br />
                <span className="text-[#FFB81C] italic">Sri Narasimha Jayanti</span>
              </h3>
              <p className="text-white/90 text-sm font-serif italic leading-snug drop-shadow max-w-[280px]">
                "The divine appearance day of Lord Narasimha, the half-man, half-lion incarnation who protects His devotees."
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-between py-12 px-6 md:hidden pointer-events-none">
          <div className="mt-4 pointer-events-auto">
            <h3 className="text-lg font-black text-white text-center uppercase tracking-wider drop-shadow-2xl font-serif leading-tight bg-black/20 backdrop-blur-sm px-6 py-2 rounded-full border border-white/10">
              Sri <span className="text-[#FFB81C]">Narasimha Jayanti</span>
            </h3>
          </div>
      ...
      {festivalImages.length > 1 && (
        <div className="mt-6 flex justify-center gap-3 overflow-x-auto pb-4 px-4 snap-x scrollbar-hide select-none max-w-4xl mx-auto">
          {festivalImages.map((img, idx) => (
            <button
              ...
              className={`relative w-20 h-14 md:w-28 md:h-20 rounded-xl overflow-hidden flex-shrink-0 transition-all duration-300 border-[3px] snap-center ${
                currentIndex === idx
                  ? "border-[#ea580c] scale-110 shadow-[0_0_15px_rgba(234,88,12,0.6)] z-10"
                  : "border-transparent opacity-50 hover:opacity-100 scale-100 shadow-md"
              }`}
            >
              <img
                src={img}
              ...
              />
              <div className={`absolute inset-0 bg-black transition-opacity duration-300 ${currentIndex === idx ? "opacity-0" : "opacity-30 hover:opacity-0"}`} />
            </button>
          ))}
        </div>
      )}
...
export default function SriNarasimhaJayantiDonationPage() {
  return (
    <div className="min-h-screen bg-[#FFF9F0] text-[#3A3A3A] font-sans selection:bg-[#FFB81C] selection:text-white">
      ...
      <section className="relative h-[60vh] min-h-[450px] flex flex-col items-center justify-center overflow-hidden bg-[#2D0A0A] pt-24 pb-8 px-4">
        ...
        {/* Left Animated Image */}
        <motion.div 
          className="absolute left-[-2rem] md:left-4 lg:left-8 bottom-[-1rem] md:bottom-0 z-20 pointer-events-none hidden sm:block opacity-80 lg:opacity-100"
          animate={{ y: [0, -15, 0] }}
          transition={{ duration: 4.5, repeat: Infinity, ease: "easeInOut" }}
        >
          <img 
            src="/donate/narasimha-jayanti/narsimha-jayanti-h1.png" 
            alt="Sri Narasimha Left" 
            className="w-48 md:w-72 lg:w-[400px] object-contain drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]"
          />
        </motion.div>

        {/* Right Animated Image */}
        <motion.div 
          className="absolute right-[-2rem] md:right-4 lg:right-8 bottom-[-1rem] md:bottom-0 z-20 pointer-events-none hidden sm:block opacity-80 lg:opacity-100"
          animate={{ y: [0, -15, 0] }}
          transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 1 }}
        >
          <img 
            src="/donate/narasimha-jayanti/narsimha-jayanti-h2.png" 
            alt="Sri Narasimha Right" 
            className="w-48 md:w-72 lg:w-[400px] object-contain drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]"
          />
        </motion.div>

        <div className="relative z-30 text-center px-4 max-w-5xl mx-auto shadow-2xl md:shadow-none bg-black/10 md:bg-transparent backdrop-blur-sm md:backdrop-blur-none rounded-3xl py-4 md:py-0 border border-white/5 md:border-transparent">
          <motion.div
          ...
          >
            ...
            <h1 className="flex flex-col items-center justify-center space-y-2">
              ...
              <span className="text-sm sm:text-lg md:text-xl lg:text-2xl font-bold text-white/90 tracking-normal drop-shadow-[0_4px_8px_rgba(0,0,0,0.4)] font-serif mt-2 text-center block">
                The divine appearance day of Lord Narasimha
              </span>
            </h1>
            ...
            <div className="inline-flex flex-col sm:flex-row items-center justify-center gap-4 bg-white/10 backdrop-blur-md px-6 py-3 rounded-2xl border border-white/20 mb-4 shadow-xl">
              <div className="text-center sm:text-left">
                ...
                <p className="text-white font-serif text-xl">Thu, April 30, 2026</p>
              </div>
              ...
              <div className="text-center sm:text-left">
                ...
                <p className="text-white font-serif text-xl">5:45 PM Onwards</p>
              </div>
            </div>
        ...
        <div className="relative mb-24 text-center w-full px-4 md:px-0">
          ...
          >
            ...
            <p className="text-gray-500 max-w-3xl mx-auto italic text-xl md:text-3xl mt-10 font-serif leading-relaxed px-4">
              "Celebrate the supreme protector, Lord Narasimhadeva, with grand offerings and devotion."
            </p>
          </motion.div>
              ...
              <div className="relative z-10">
                <div className="text-center mb-10">
                  ...
                  <h3 className="text-3xl md:text-5xl font-bold text-[#701a1a] font-serif">
                    What Is <span className="text-[#FFB81C]">Sri Narasimha Jayanti?</span>
                  </h3>
                ...
                <div className="grid lg:grid-cols-2 gap-8 items-start">
                  <div className="space-y-5 text-[#5a5a5a] text-base md:text-lg leading-relaxed">
                    <p>
                      <strong className="text-[#701a1a]">Sri Narasimha Jayanti</strong> celebrates the divine appearance of
                      <strong className="text-[#701a1a]"> Lord Narasimha</strong>, the half-man, half-lion incarnation of the Supreme Lord, who appeared to protect His pure devotee Prahlada Maharaja and vanquish the demon Hiranyakashipu.
                    </p>
                    <p>
                      In the Vaishnava tradition, Lord Narasimha is worshiped as the supreme protector who removes all obstacles on the path of devotional service and destroys the ignorance within our hearts.
                    </p>
                    <p>
                      This auspicious festival is observed by fasting till dusk, followed by a grand abhishekam, arati, kirtan, and a drama depicting the pastimes of the Lord. By participating in this festival, devotees receive the blessings of fearlessness and spiritual strength.
                    </p>
                  </div>
                  ...
                  <div className="rounded-[2rem] bg-gradient-to-br from-[#fff7ed] to-[#FFF9F0] border border-[#FFB81C]/30 p-6 md:p-8 shadow-lg">
                    ...
                    <div className="space-y-4">
                      {[
                        "Honors the appearance of Lord Narasimha, the protector of devotees.",
                        "Reminds us of the Lord's omnipresence and His vow to protect the surrendered souls.",
                        "Invites devotees to offer special prayers for removing obstacles in devotional service.",
                        "Supports Deity worship, special offerings, and prasadam distribution.",
                      ].map((point, idx) => (
          ...
          <div className="lg:col-span-7 space-y-10">
            <div className="flex items-center gap-6 border-b border-gray-100 pb-6">
              ...
              <div>
                ...
                <p className="text-[#ea580c] font-bold text-sm tracking-widest uppercase">Thu, April 30, 2026</p>
              </div>
            </div>
            ...
            <div className="space-y-8 relative before:absolute before:left-[19px] before:top-2 before:bottom-2 before:w-[2px] before:bg-gradient-to-b before:from-[#ea580c] before:via-[#FFB81C] before:to-transparent">
              {[
                { title: "Abhishekam", desc: "A spectacular bathing ceremony of the Deities with auspicious ingredients, accompanied by Vedic mantras." },
                { title: "Narasimhavatara drama", desc: "A theatrical performance bringing to life the divine pastimes of Prahlada Maharaja and Lord Narasimha." },
                { title: "Arati & Kirtan", desc: "Join the glowing evening worship with lamps, conch, and heartfelt prayers to the supreme protector." },
              ].map((item, idx) => (
            ...
            <div className="bg-[#FFF9F0] p-10 rounded-[3rem] border-2 border-dashed border-[#FFB81C]/40 relative overflow-hidden group shadow-inner">
              ...
              <div className="relative z-10 text-center space-y-6">
                ...
                <p className="text-gray-600 italic text-lg leading-relaxed font-serif">
                  "Offer your prayers, presence, and seva on Sri Narasimha Jayanti. Let this sacred festival become an occasion of devotion for your whole family."
                </p>
                <div className="pt-8 border-t border-[#FFB81C]/20 text-center space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4">
                    <div className="rounded-2xl bg-white/80 p-4 border border-[#FFB81C]/20">
                      ...
                      <p className="text-[#2D0A0A] font-serif text-lg">5:45 PM</p>
                    </div>
                    <div className="rounded-2xl bg-white/80 p-4 border border-[#FFB81C]/20">
        ...
        >
          ...
          <div className="relative z-10 space-y-8">
            <p className="text-[#666666] text-xl leading-relaxed font-serif italic mb-8">
              "By contributing to Sri Narasimha Jayanti Mahotsava, you help support the festival offerings, decorations, worship, and prasadam seva performed in honor of Lord Narasimhadeva."
            </p>

            <a
              href="https://rzp.io/rzp/zcasiHF"
              target="_blank"
          ...
          {[
            {
              ...
              desc: "Participate in a sacred festival dedicated to Lord Narasimha and receive His immense protection and grace.",
