        ...
        <div className="container mx-auto text-center relative z-10 px-4">
          ...
          >
            ...
            <h1 className="text-4xl md:text-7xl font-bold text-white mb-4 tracking-tight drop-shadow-[0_4px_8px_rgba(0,0,0,0.6)]">
              Sudama <span className="text-[#FFB81C] font-serif italic">Seva</span>
            </h1>
            ...
            <p className="text-xl md:text-2xl text-[#ffe8cc] font-light leading-relaxed max-w-3xl mx-auto italic">
              "Quarterly Giving Program - ₹5,000/quarter"
            </p>
          </motion.div>
        </div>
      </section>
        ...
        >
          ...
          <div className="relative bg-[#FFF9F0] p-1.5 rounded-[2rem] shadow-xl overflow-hidden">
            ...
            <div className="bg-white rounded-[1.7rem] p-8 relative overflow-hidden h-full">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-2xl font-bold mb-4 text-[#701a1a] font-serif">Sudama <span className="text-[#FFB81C]">Seva</span></h2>
          ...
          <Card className="border-2 border-[#FFB81C]/30 rounded-2xl shadow-xl overflow-hidden">
            ...
            <CardContent className="pt-6 space-y-4 text-[#666666] bg-white">
              {[
                { label: "Frequency", value: "Quarterly (4 times per year)" },
                { label: "Flexibility", value: "Adjust amount or cancel anytime" },
                { label: "Tax Benefit", value: "Section 80G tax deduction" },
                { label: "Receipt", value: "Quarterly receipt via email" },
              ].map((item, idx) => (
          ...
          <div className="bg-white rounded-[2rem] p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-[#701a1a] font-serif">Set Up Your Quarterly <span className="text-[#FFB81C]">Donation</span></h3>
              </div>
              ...
              <form className="space-y-6 max-w-2xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="block text-[#701a1a] font-semibold mb-2">Quarterly Amount (₹)</label>
                    <input
                      type="number"
                      className="w-full px-4 py-3 border-2 border-[#FFB81C]/30 rounded-xl focus:outline-none focus:border-[#FFB81C] bg-[#FFF9F0]"
                      placeholder="5000"
                ...
                >
                  <Heart size={20} className="fill-current" /> Set Up Quarterly Donation
                </button>
              </form>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[2rem] p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="text-center mb-10">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-[#701a1a] font-serif">Sudama Seva <span className="text-[#FFB81C]">Benefits</span></h3>
              </div>
              
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  { title: "Quarterly Impact Reports", desc: "Detailed reports on major initiatives and their outcomes." },
                  { title: "Community Recognition", desc: "Featured in our quarterly community newsletter." },
                  { title: "Special Puja Offerings", desc: "Special prayers and puja offerings in your name." },
                  { title: "VIP Event Access", desc: "VIP invitations to major temple events and celebrations." },
                ].map((item, idx) => (
