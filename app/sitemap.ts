...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/blog/vyasa-puja-guide-offering`,                          lastModified: now, changeFrequency: 'yearly',  priority: 0.8 },
    { url: `${BASE_URL}/blog/sri-bhaktivinoda-thakura-life-teachings-legacy`,     lastModified: now, changeFrequency: 'yearly',  priority: 0.8 },
    { url: `${BASE_URL}/blog/chhera-pahara-jagannath-ratha-yatra`,                lastModified: now, changeFrequency: 'yearly',  priority: 0.8 },
    { url: `${BASE_URL}/blog/pahandi-bije-jagannath-ratha-yatra`,                 lastModified: now, changeFrequency: 'yearly',  priority: 0.8 },
