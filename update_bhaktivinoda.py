            ...
            <article className="at-blog-wrap">
                ...
                <div className="sp-content-body">
                    ...
                    <div className="sp-connect-grid">
                        ...
                        <a href="https://www.youtube.com/@HareKrsnaMovementChennai" target="_blank" rel="noopener noreferrer" className="sp-connect-card">
                            <span className="sp-connect-icon">▶</span>
                            <div className="sp-connect-info">
                                <span className="sp-connect-label">YouTube</span>
                                <span className="sp-connect-value">@HareKrsnaMovementChennai</span>
                            </div>
                            <span className="sp-connect-arrow">→</span>
                        </a>
                    </div>
...
with open('e:/volddata/InternShipLinksUs/HKM-Landing-Test-2/app/blog/sri-bhaktivinoda-thakura-life-teachings-legacy/BlogClient.tsx', 'w', encoding='utf-8') as f:
    f.write(get_blog_content())
